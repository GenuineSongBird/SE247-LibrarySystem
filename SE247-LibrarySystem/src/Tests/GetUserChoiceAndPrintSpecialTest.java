...
public class GetUserChoiceAndPrintSpecialTest {
	...
	public void test() {
		...
		String[] special = {" detail 1", "detail 2"};
		assertEquals(SP.getUserChoiceAndPrintSpecial(choices, choices.length, special), output);
	}
